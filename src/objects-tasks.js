...
function compareObjects(obj1, obj2) {
  const objToString1 = JSON.stringify(obj1);
  const objToString2 = JSON.stringify(obj2);

  return objToString1 === objToString2;
}
...
function fromJSON(proto, json) {
  ...
  return Object.assign(new proto.constructor(), obj);
}
